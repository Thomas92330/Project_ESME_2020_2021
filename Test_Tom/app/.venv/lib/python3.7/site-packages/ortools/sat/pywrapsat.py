...
class SatHelper(object):
    ...
    def WriteModelToFile(model_proto: "operations_research::sat::CpModelProto const &", filename: "std::string const &") -> "bool":
        return _pywrapsat.SatHelper_WriteModelToFile(model_proto, filename)
...
def SatHelper_WriteModelToFile(model_proto: "operations_research::sat::CpModelProto const &", filename: "std::string const &") -> "bool":
    return _pywrapsat.SatHelper_WriteModelToFile(model_proto, filename)
